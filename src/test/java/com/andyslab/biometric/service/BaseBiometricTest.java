...
public abstract class BaseBiometricTest {
    ...
    protected static final File DB_FILE = new File(System.getProperty("java.io.tmpdir"),
    ...
    /**
     * Sub-classes can override this method to load the database with initial
     * templates
     */
    ...
    protected BiometricSubject loadSubjectFromResource(String subjectId) throws Exception {
        InputStream templateStream = getClass().getClassLoader()
                .getResourceAsStream("org/pih/biometric/service/" + subjectId);
